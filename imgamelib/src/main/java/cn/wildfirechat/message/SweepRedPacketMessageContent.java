...
import static cn.wildfirechat.message.core.MessageContentType.ContentType_Sweep_red_packet_remind;

/**
 * 红包消息
 */

@ContentTag(type = ContentType_Sweep_red_packet_remind, flag = PersistFlag.Persist_And_Count)
public class SweepRedPacketMessageContent extends MessageContent {
    ...
    public SweepRedPacketMessageContent() {
    }

    public SweepRedPacketMessageContent(RedPack redPack) {
    ...
    public String digest(Message message) {
        return "[扫雷红包]" + redPacketName;
    }


    protected SweepRedPacketMessageContent(Parcel in) {
        super(in);
    ...
    public static final Creator<SweepRedPacketMessageContent> CREATOR = new Creator<SweepRedPacketMessageContent>() {
        @Override
        public SweepRedPacketMessageContent createFromParcel(Parcel in) {
            return new SweepRedPacketMessageContent(in);
        }

        @Override
        public SweepRedPacketMessageContent[] newArray(int size) {
            return new SweepRedPacketMessageContent[size];
        }
    };
