...
public interface MessageContentType {
    ...
    //自定义消息type要做1000以上
    int ContentType_red_packet = 1118; //红包消息
    int ContentType_red_packet_remind = 1119; //红包消息提醒

    int ContentType_Sweep_red_packet_remind = 1120; //扫雷红包消息提醒

    int ContentType_niuniu_red_packet_remind = 1130; //牛牛红包消息提醒

    int ContentType_red_packet_remind_close = 1140; //红包结算的通知消息

    int ContentType_niuniu_red_packet_over = 1150; //牛牛红包结算的通知消息
}
