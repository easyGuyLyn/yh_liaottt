...
public enum IMErrorCodeEnum {
    ...
    public static String getCodeNameByCode(int codeee) {
        String codeName = "";
        for (IMErrorCodeEnum specialSiteEnum : IMErrorCodeEnum.values()) {
            if (codeee == specialSiteEnum.getCode()) {
                codeName = specialSiteEnum.getName();
                break;
            }
        }
        return codeName;
