    ...
    class MemberViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindUserInfo(UserInfo userInfo) {
            if (userInfo == null) {
                ...
                portraitImageView.setImageResource(R.mipmap.im_default_header);
                return;
            }
            ...
            Glide.with(portraitImageView).load(userInfo.portrait).apply(new RequestOptions().centerCrop().placeholder(R.mipmap.im_default_header)).into(portraitImageView);
        }

        public void bindAddMember() {
            nameTextView.setVisibility(View.GONE);
            portraitImageView.setImageResource(R.mipmap.im_ic_add_team_member);
            this.type = TYPE_ADD;
