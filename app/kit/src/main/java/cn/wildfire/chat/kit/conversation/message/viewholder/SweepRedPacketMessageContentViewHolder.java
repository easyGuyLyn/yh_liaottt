...
@MessageContentType(value = {
        SweepRedPacketMessageContent.class
})
...
@EnableContextMenu
public class SweepRedPacketMessageContentViewHolder extends NormalMessageContentViewHolder {
    ...
    public SweepRedPacketMessageContentViewHolder(ConversationFragment fragment, RecyclerView.Adapter adapter, View itemView) {
    ...
    public void onBind(UiMessage message) {
        ...
        SweepRedPacketMessageContent redPacketMessageContent = (SweepRedPacketMessageContent) message.message.content;
        tvRedPacketName.setText("扫雷红包  " + redPacketMessageContent.redPacketName);
...
//                dismissAllowingStateLoss();
     ...
     * 红包未领取
     */
    public void unclaimed(SweepRedPacketMessageContent redPacketMessageContent) {
...
//                        messageViewModel.sendRedPacketHintMsg(message.message.conversation, redPackNotification);
     ...
     * 已领取
     */
    public void alreadyReceived(SweepRedPacketMessageContent redPacketMessageContent) {
        FragmentActivity activity = fragment.getActivity();
        Intent intent = new Intent(fragment.getActivity(), RedPacketParticularsActivity.class);
        intent.putExtra(ConstantValue.ARG_PARAM2, true);
        intent.putExtra(ConstantValue.ARG_PARAM1, redPacketMessageContent.redPacketId);
     ...
     * 已过期
     */
    public void pastDue(SweepRedPacketMessageContent redPacketMessageContent) {
        alreadyReceived(redPacketMessageContent);
    }
