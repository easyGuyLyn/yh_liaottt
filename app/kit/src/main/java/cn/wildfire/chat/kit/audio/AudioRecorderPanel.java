...
public class AudioRecorderPanel implements View.OnTouchListener {
    ...
    private void showRecording() {
        if (recordingWindow == null) {
            View view = View.inflate(context, R.layout.im_audio_popup_wi_vo, null);
        ...
        stateTextView.setText(R.string.im_voice_rec);
        stateTextView.setBackgroundResource(R.drawable.im_bg_voice_popup);
    ...
    private void showCancelTip() {
        ...
        stateTextView.setBackgroundResource(R.drawable.im_corner_voice_style);
    }
