...
public class ConversationFragment extends Fragment implements
    ...
    @BindView(R.id.img_live_streaming)
    ImageView imgLiveStreaming;
    @BindView(R.id.img_playing)
    ImageView imgPlaying;
    @BindView(R.id.img_joinin)
    ImageView imgJoinin;
    @BindView(R.id.img_bet)
    ImageView imgBet;

    @BindView(R.id.floating_window)
    LinearLayout floatingWindow;
    ...
    @OnClick({R.id.img_recharge, R.id.img_live_streaming, R.id.img_playing, R.id.img_joinin, R.id.img_bet})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.img_live_streaming: //直播
                break;
            case R.id.img_playing:  //规则
                Intent intent = new Intent(getActivity(), RedPacketRegulationActivity.class);
                startActivity(intent);
                break;
            case R.id.img_joinin:  //加盟
                break;
            case R.id.img_bet: //投注
                break;
        }
    }
}
