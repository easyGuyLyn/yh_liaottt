...
import com.nwf.sports.chat.location.data.LocationData;
...
import cn.wildfirechat.message.notification.RedPackNotification;
...
//        Uri imageFileSourceUri = Uri.fromFile(imageFileSource);
    ...
    private void playAudio(UiMessage message, File file) {
        ...
        AudioPlayManager.getInstance().startPlay(IMApplication.getContext(), uri, new IAudioPlayListener() {
            @Override
     ...
     * @param redPack
     */
    public void sendRedPacketMsg(Conversation conversation, RedPack redPack) {
        RedPacketMessageContent redPacketMessageContent = new RedPacketMessageContent(redPack);
     ...
     * @param redPack
     */
    public void sendSweepRedPacketMsg(Conversation conversation, RedPack redPack) {
        SweepRedPacketMessageContent redPacketMessageContent = new SweepRedPacketMessageContent(redPack);
        sendMessage(conversation, redPacketMessageContent);
    }
     ...
     * @param redPack
     */
    public void sendNiuniuRedPacketMsg(Conversation conversation, RedPack redPack) {
        NiuniuRedPacketMessageContent redPacketMessageContent = new NiuniuRedPacketMessageContent(redPack);
        sendMessage(conversation, redPacketMessageContent);
    }
     ...
     * @param conversation
     */
    public void sendRedPacketHintMsg(Conversation conversation, RedPackNotification redPackNotification) {
        RedPacketNotificationContent redPacketNotificationContent = new RedPacketNotificationContent(redPackNotification);
        sendMessage(conversation, redPacketNotificationContent);
    }
