package com.nwf.sports.chat.location.ui.activity;
...
import com.nwf.sports.chat.location.ui.base.BaseActivity;
import com.nwf.sports.chat.location.ui.presenter.MyLocationAtPresenter;
import com.nwf.sports.chat.location.ui.view.IMyLocationAtView;
...
//        mSensorManager.registerListener(MyLocationActivity.this, mOritationSensor, SensorManager.SENSOR_DELAY_NORMAL);
    ...
    public void onLocationChanged(TencentLocation tencentLocation, int i, String s) {
        ...
        if (i == tencentLocation.ERROR_OK) {
            ...
            if (myLocation == null) {
                myLocation = mTencentMap.addMarker(new MarkerOptions().position(latLng).icon(BitmapDescriptorFactory.fromResource(R.mipmap.im_arm)).anchor(0.5f, 0.8f));
            }
            if (accuracy == null) {
