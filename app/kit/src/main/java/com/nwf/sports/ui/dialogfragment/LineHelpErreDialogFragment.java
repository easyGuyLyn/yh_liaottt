 ...
 * <p>修改备注：
 **/
public class LineHelpErreDialogFragment extends BaseDialogFragment {
    ...
    protected int getViewId() {
        return R.layout.dialogfragment_line_error;
    }
    ...
    public LineHelpErreDialogFragment setTvTitle(String title) {
        this.title = title;
        return this;
    }

    public LineHelpErreDialogFragment setTvContent(String content) {
        this.content = content;
        return this;
    }

    public LineHelpErreDialogFragment setOnLeftButtonListener(View.OnClickListener onClickListener, String name) {
        mOnLeftButtonListener = onClickListener;
        mLeftButtonName = name;
        return this;
    }

    public LineHelpErreDialogFragment setOnRightButtonListener(View.OnClickListener onClickListener, String name) {
