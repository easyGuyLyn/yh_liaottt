...
//    String IM_SERVER_HOST = "10.91.6.19";//Bake本地环境
//    String IM_SERVER_HOST = "10.91.37.3";//测试环境
//    String IM_SERVER_HOST = "110.173.53.28";//UAT环境
//    String IM_SERVER_HOST = "110.173.49.42";//正式环境
...
//    String APP_SERVER_ADDRESS = "http://110.173.49.42:8888/"; //正式环境
    ...
    static void validateConfig() {
        ...
        if (!RetrofitHelper.imHost().equals("wildfirechat.cn")) {
