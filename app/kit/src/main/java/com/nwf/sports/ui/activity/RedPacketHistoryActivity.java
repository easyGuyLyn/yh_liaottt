...
import com.nwf.sports.ui.fragment.GeneralRedPacketHistoryFragment;
 ...
 * <p>修改备注：
 **/
public class RedPacketHistoryActivity extends BaseActivity implements TabLayout.OnTabSelectedListener {
    ...
    private String[] title = {"普通红包", "游戏红包"};
    ...
    protected void initViews() {
        ...
        fragmentList.add(GeneralRedPacketHistoryFragment.newInstance("0"));
        fragmentList.add(GeneralRedPacketHistoryFragment.newInstance("1"));
