...
import com.nwf.sports.listener.ResourceGetter;
...
//        resourceGetter = resGetter;
    ...
    public static CheckResult collect(CheckResult... results)
    {
        ...
        if (null != collectResult)
        {
            ...
            LogUtils.e(collectResult.toString());
    ...
    public static CheckResult checkSame(CharSequence first, CharSequence second, @StringRes int strid)
    {
        ...
        {
            checkResult.msg = ResHelper.getString(strid);
            return checkResult;
        }
        return new CheckResult(true);
    }
    ...
    public static CheckResult checkNotEmpty(CharSequence input, @StringRes int stringid)
    {
        ...
        {
            CheckResult checkResult = new CheckResult(false);
            checkResult.msg = ResHelper.getString(stringid);
            return checkResult;
        }
        return new CheckResult(true);
    }
    ...
    public static CheckResult checkSmsCode(String smscode)
    {
        ...
        {
            checkResult.msg = ResHelper.getString(R.string.str_empty_smscode);
            return checkResult;
        }

        if (smscode.length() != 6)
        {
            checkResult.msg = ResHelper.getString(R.string.str_validlength_of_smscode);
            return checkResult;
        }
        ...
        for (char achar : smscode.toCharArray())
        {
            ...
            {
                checkResult.msg = ResHelper.getString(R.string.str_number_only_smscode);
                return checkResult;
            }
        }
    ...
    public static CheckResult checkPhoneNumber(String number, @StringRes int emptyStringId, @StringRes int invalidStringId)
    {
        ...
        {
            checkResult.msg = ResHelper.getString(emptyStringId);
            return checkResult;
        }
        if (!RegexUtils.isMobileExact(number))
        {
            checkResult.msg = ResHelper.getString(invalidStringId);
            return checkResult;
        }
    ...
    public static CheckResult checkPhoneNumber(String number)
    {
        ...
        if (Check.isEmpty(number))
        {
            checkResult.msg = ResHelper.getString(R.string.str_phone_empty);
            return checkResult;
        }

        /*if (!RegexUtils.isMobileExact(number)) {
            checkResult.msg = ResHelper.getString(R.string.str_phone_invalid);
            return checkResult;
        }*/
    ...
    public static CheckResult checkUsername(String username)
    {
        ...
        {
            checkResult.msg = ResHelper.getString(R.string.str_username_empty);
            return checkResult;
        }
        ...
        {
            checkResult.msg = ResHelper.getString(R.string.str_username_invalid);
            return checkResult;
        }
        return new CheckResult(true);
    }
    ...
    public static CheckResult checkPassword(String password, @StringRes int emptystrid, @StringRes int invalidstrid)
    {
        ...
        {
            checkResult.msg = ResHelper.getString(emptystrid);
            return checkResult;
        }
        Pattern pattern = Pattern.compile("[a-zA-Z0-9]{8,10}");
        if (!pattern.matcher(password).matches())
        {
            checkResult.msg = ResHelper.getString(invalidstrid);
            return checkResult;
        }
        return new CheckResult(true);
    }
    ...
    public static CheckResult checkRemark(CharSequence charSequence)
    {
        ...
        if (!Check.isEmpty(charSequence))
        {
            ...
            {
                checkResult.msg = ResHelper.getString(R.string.)
                return checkResult;
            }*/
            if (remark.length() > 22)
            {
                checkResult.msg = ResHelper.getString(R.string.str_withdraw_remark_toolong);
                return checkResult;
            }
        }
        return new CheckResult(true);
    ...
    public static CheckResult checkWithdrawMoney(CharSequence charSequence, String balance)
    {
        ...
        {
            //checkResult.msg = ResHelper.getString(R.string.str_withdraw_no_money_input);
            return checkResult;
        }

        if (!pattern.matcher(charSequence.toString()).matches())
        {
            checkResult.msg = ResHelper.getString(R.string.str_withdraw_money_format_error);
            return checkResult;
        }
        ...
        try
        {
            ...
            {
                checkResult.msg = ResHelper.getString(R.string.str_withdraw_money_balance_toosmall);
                return checkResult;
            }
            ...
            {
                checkResult.msg = ResHelper.getString(R.string.str_withdraw_money_must_above_100);
                return checkResult;
            }

            if (money.compareTo(bigDecimalBalance) > 0)
            {
                checkResult.msg = ResHelper.getString(R.string.str_withdraw_money_balance_insufficient);
                return checkResult;
            }
        }
        catch (NumberFormatException ex)
        {
            ...
            checkResult.msg = ResHelper.getString(R.string.str_withdraw_money_invalid);
            return checkResult;
        }
        catch (Exception e)
        {
    ...
    public static CheckResult checkFundShiftMoney(String money, String balance)
    {
        ...
        {
            checkResult.msg = ResHelper.getString(R.string.str_fundshift_money_invalid);
            return checkResult;
        }
        ...
        {
            checkResult.msg = ResHelper.getString(R.string.str_fundshift_money_less);
            return checkResult;
        }
    ...
    public static CheckResult checkAccountName(CharSequence input)
    {
        ...
        if (Check.isEmpty(input))
        {
            checkResult.msg = ResHelper.getString(R.string.str_addbank_empty_account_name);
            return checkResult;
        }
        if (input.length() > 20)
        {
            checkResult.msg = ResHelper.getString(R.string.str_addbank_account_name_toolong);
            return checkResult;
        }
        Pattern pattern = Pattern.compile("[\u4e00-\u9fa5_a-zA-Z.·•▪·.]{2,20}");
        if (!pattern.matcher(input).matches())
        {
            checkResult.msg = ResHelper.getString(R.string.str_addbank_invalid_account_name);
            return checkResult;
        }
    ...
    public static CheckResult checkAccountNO(CharSequence input)
    {
        ...
        if (Check.isEmpty(input))
        {
            checkResult.msg = ResHelper.getString(R.string.str_addbank_account_no_empty);
            return checkResult;
        }
        if (input.length() > 19)
        {
            checkResult.msg = ResHelper.getString(R.string.str_addbank_account_no_toolong);
            return checkResult;
        }
        ...
        if (!pattern.matcher(input).matches())
        {
            checkResult.msg = ResHelper.getString(R.string.str_addbank_account_no_invalid);
            return checkResult;
        }
    ...
    public static CheckResult checkAccountSite(CharSequence sequence)
    {
        ...
        {
            checkResult.msg = ResHelper.getString(R.string.str_addbank_account_site_empty);
            return checkResult;
        }

        if (sequence.length() > 20)
        {
            checkResult.msg = ResHelper.getString(R.string.str_addbank_account_site_toolong);
            return checkResult;
        }
        ...
        {
            checkResult.msg = ResHelper.getString(R.string.str_addbank_account_site_invalid);
            return checkResult;
        }
        return new CheckResult(true);
    }
