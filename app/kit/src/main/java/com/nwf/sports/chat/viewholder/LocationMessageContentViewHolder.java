package com.nwf.sports.chat.viewholder;
...
public class LocationMessageContentViewHolder extends NormalMessageContentViewHolder {
    ...
    public void onClick(View view) {
        Toast.makeText(fragment.getContext(), "打开--ShowLocationActivity", Toast.LENGTH_SHORT).show();
        Log.e("TT", "打开--ShowLocationActivity");
